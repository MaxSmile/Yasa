...
public class SquareCameraPreview extends SurfaceView {
    public static final String TAG = com.getyasa.yasa.fragmented.camera.SquareCameraPreview.class.getSimpleName();
    ...
    /**
     * Application is always in the portrait mode
     */
    final boolean isPortrait = true;
