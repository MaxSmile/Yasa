...
public class RuntimePermissionActivity extends AppCompatActivity {
    ...
    public static void startActivity(@NonNull final Fragment fragment,
        ...
        final Intent intent = new Intent(fragment.getActivity(),  com.getyasa.yasa.fragmented.camera.RuntimePermissionActivity.class);
    ...
    private ArrayList<String> getPermissionNeeded(@NonNull final ArrayList<String> reqPermissions) {
        ...
        for (String reqPermission : reqPermissions) {
            if (ContextCompat.checkSelfPermission( com.getyasa.yasa.fragmented.camera.RuntimePermissionActivity.this, reqPermission)
    ...
    private ArrayList<String> getPermissionRationaleNeeded(@NonNull final ArrayList<String> permissionsNeeded) {
        ...
        for (String permissionNeeded : permissionsNeeded) {
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(
                     com.getyasa.yasa.fragmented.camera.RuntimePermissionActivity.this, permissionNeeded)) {
    ...
    private void showPermissionRationaleDialog(final String message, final String[] permissions) {
        new AlertDialog.Builder( com.getyasa.yasa.fragmented.camera.RuntimePermissionActivity.this)
                .setMessage(message)
                .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                         com.getyasa.yasa.fragmented.camera.RuntimePermissionActivity.this.requestForPermission(permissions);
                    }
                })
                .setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                         com.getyasa.yasa.fragmented.camera.RuntimePermissionActivity.this.sendResult(false);
                    }
                })
    ...
    private void requestForPermission(final String[] permissions) {
        ActivityCompat.requestPermissions( com.getyasa.yasa.fragmented.camera.RuntimePermissionActivity.this, permissions, REQUEST_CODE);
    }
