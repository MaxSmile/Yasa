 ...
 */
public class EditSavePhotoFragment extends com.getyasa.yasa.fragmented.camera.YasaCameraBaseFragment {

    public static final String TAG =  com.getyasa.yasa.fragmented.camera.EditSavePhotoFragment.class.getSimpleName();
    ...
    public static com.getyasa.yasa.fragmented.camera.EditSavePhotoFragment newInstance(byte[] bitmapByteArray, int rotation,
                                                                                       @NonNull ImageParameters parameters) {
        com.getyasa.yasa.fragmented.camera.EditSavePhotoFragment fragment = new com.getyasa.yasa.fragmented.camera.EditSavePhotoFragment();
...
//        Log.d(TAG, "original bitmap width " + bitmap.getWidth() + " height " + bitmap.getHeight());
    ...
    private void requestForPermission() {
        RuntimePermissionActivity.startActivity( com.getyasa.yasa.fragmented.camera.EditSavePhotoFragment.this,
                REQUEST_STORAGE,
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (REQUEST_STORAGE == requestCode && data != null) {
            ...
            if (isGranted && view != null) {
                ...
                parentActivity.navigateWithPhotoUri(photoUri);
            }
        } else {
